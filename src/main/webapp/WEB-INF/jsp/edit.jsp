...
<form class="section" action = "Airline" method="POST">
    <div><input name="command" value="updateProfile" type="hidden"/></div>
    ...
    <div class="input-data">
        <div class="input-block">
            ...
            <input type="text" id="login" name="login" value="${user.userAuthentication.login}" required />
        </div>
    </div>
    <div class="input-data">
        <div class="input-block">
            <label for=""><fmt:message key="password" bundle="${bundle}" /></label>
            <input type="password" id="password" name="password"  value = "${user.userAuthentication.password}" required />
        </div>
    </div>
